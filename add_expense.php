...
if (isset($_POST['add'])) {
    ...
    $expense = "INSERT INTO expense (user_id, expense, expensedate,expensecategory) VALUES ('$userid', '$expenseamount','$expensedate','$expensecategory')";
    $result = mysqli_query($con, $expense) or die("Something Went Wrong!");
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = true;
    $record = mysqli_query($con, "SELECT * FROM expense WHERE user_id='$userid' AND expense_id=$id");
...
<head>
    ...
    <title>DompetKu - Add Expense</title>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="border-right" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="add_expense.php" class="list-group-item list-group-item-action sidebar-active"><span data-feather="plus-square"></span> Add Expense</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <h3 class="mt-4 text-center">Add Your Daily Expense</h3>
                <hr>
                <div class="row ">
                    ...
                    <div class="col-md" style="margin:0 auto;">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label for="expenseamount" class="col-sm-6 col-form-label"><b>Enter Amount (IDR)</b></label>
                                <div class="col-md-6">
